	...
	<div class="container">
		...
		<div class="card shadow  mb-5 bg-body rounded" style="width: 800px">
			<h5 class="card-header"
				style="height: 70px; font-size: 25px; background-color: #18334f; color: white;">Category</h5>
			<b><font color="red"> <%=ServletUtility.getErrorMessage(request)%>
			</font></b> <b><font color="Green"> <%=ServletUtility.getSuccessMessage(request)%>
			</font></b>
			<div class="card-body">
				<form role="form" action="<%=IMSView.CATEGORY_CTL%>"
					method="post" enctype="multipart/form-data">

					<jsp:useBean id="bean" class="in.co.insurance.mgt.bean.CategoryBean"
