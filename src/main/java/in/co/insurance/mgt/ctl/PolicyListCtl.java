...
/**
 * Servlet implementation class PolicyListCtl
 */
@WebServlet(name = "PolicyListCtl", urlPatterns = { "/ctl/policyList" })
public class PolicyListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("PolicyListCtl populateBean method start");
		...
		log.debug("PolicyListCtl populateBean method end");
		return bean;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("PolicyListCtl doGet method start");
		List list = null;
		...
		log.debug("PolicyListCtl doGet method end");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("PolicyListCtl doPost method start");
		List list = null;
		...
		if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op) || OP_PREVIOUS.equalsIgnoreCase(op)) {
			...
			if (ids != null && ids.length > 0) {
				PolicyBean deletebean = new PolicyBean();
				for (String id : ids) {
		...
		log.debug("PolicyListCtl doPost method end");
	}
	@Override
	protected String getView() {
		return IMSView.POLICY_LIST_VIEW;
	}
